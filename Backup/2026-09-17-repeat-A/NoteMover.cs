...
public class NoteMover : MonoBehaviour
{
                     ...
                     bool isChainTap = false, int chainTapCount = 0, float chainTapHoldDuration = 0.4f, float chainTapGoodWindow = 0.07f)
    {
        ...
        {
            Sprite sel = isWideTap ? NoteSpriteLibrary.Instance.wideSelect
        ...
        textured = (isPlainTap && tapTex != null) || (isWideTap && wideTex != null) || isSmallTextured;
        Texture2D activeTex = isWideTap ? wideTex : (isSmallTap ? smallTex : tapTex);          // 实际用于渲染的贴图
