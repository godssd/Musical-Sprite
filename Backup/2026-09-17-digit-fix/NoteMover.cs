...
public class NoteMover : MonoBehaviour
{
    ...
    [Tooltip("数字浮起高度（音符局部 Y，会被卡面 0.12 缩放；约 0.5≈贴着卡顶）。可在运行时拖。")]
    public float digitYOffset = 0.55f;
    ...
    private void CreateDigitSprites(int count)
    {
        ...
        digitRoot.transform.localPosition = new Vector3(0f, digitYOffset, 0f); // 局部 Y，过卡面 0.12 缩放
